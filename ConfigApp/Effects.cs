...
namespace ConfigApp
{
    public static class Effects
    {
        ...
        public enum EffectType
        {
            ...
            EFFECT_PLAYER_QUICK_REFRESHMENT,
            _EFFECT_ENUM_MAX
        }
        ...
        public static readonly Dictionary<EffectType, EffectInfo> EffectsMap = new Dictionary<EffectType, EffectInfo>()
        {
            ...
            {EffectType.EFFECT_PLAYER_QUICK_REFRESHMENT, new EffectInfo("Quick refreshment", EffectCategory.PLAYER, "player_quick_refreshment")},
        };
    }
}
